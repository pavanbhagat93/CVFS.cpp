...
void man(char *name)
{
    ...
    {
        printf("Description : Used to read data for regular file\n");
    ...
    {
        printf("Description : Used to display information of files\n");
        printf("Usage :star File_Descriptor \n");
    }
...
void DisplayHelp()
{
    ...
    printf("closall : To close all opened file\n");
    ...
    CreateDILB();
     ...
     while(1) // consider as shell
     {
        ...
        if(count == 1)
        {
            ...
            {
                printf("Terminating the Marvellous Virtual File systemm\n");
                 break;
             }
            else
            {
        ...
        else if(count == 2)
        {
           ...
           else if(strcmp(command[0],"man") == 0)
           {
            ...
            {  
                ...
                if(fd == -1)
                {
                     printf("Error: Incorrect parameter continue");
                    continue;
                }
       ...
       else if(count == 3)
      {
        ...
        else if(strcmp(command[0], "open") == 0)
        {
            ...
            if(ret >= 0)
                printf("File is successfully opened with filldescriptor:%d\n",ret);
            if(ret == -1)
                printf("ERROR: Incorrect parameters\n");
            if(ret == -2)
